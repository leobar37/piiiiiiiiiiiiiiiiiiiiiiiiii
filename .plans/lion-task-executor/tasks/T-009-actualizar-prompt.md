...
## Objetivo
Actualizar el system prompt de planificación para reflejar la nueva tool `lion_tasks`.

## Cambios en `packages/extensions/src/extensions/lion/prompts/planning.ts`
...
- [ ] El prompt describe `lion_tasks` claramente
- [ ] El prompt explica las 3 estrategias
- [ ] El prompt lista las definiciones disponibles
- [ ] El prompt incluye ejemplos de uso
- [ ] El prompt mantiene las instrucciones originales de planificación

## Notas

- El prompt debe ser conciso pero informativo
- Los ejemplos ayudan al orquestador a entender el patrón
- Mantener la sección de formato de plan estructurado
